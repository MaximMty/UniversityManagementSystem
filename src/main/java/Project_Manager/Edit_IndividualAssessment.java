 ...
 * @author zrche
 */
public class Edit_IndividualAssessment extends javax.swing.JFrame {

    /**
     * Creates new form Edit_IndividualAssessment
     */
    public Edit_IndividualAssessment() {
        initComponents();
        UserIDLbl.setText(Login.getId());
        populateLecturerId();
        AddSelectedInfo(IndividualAssessment_Info.getAssessment());
    }
    ...
    public void AddSelectedInfo(Assessment assessment){
        ShowStudentIdLbl.setText(assessment.getStudentId());
    ...
    private void EditBttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditBttnActionPerformed
        ...
        while(!error){
            studentId = ShowStudentIdLbl.getText();
            ...
            projectManager.editIndividualAssessment(studentId, assessmentType, supervisor, secondMarker, formattedDate);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_IndividualAssessment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
