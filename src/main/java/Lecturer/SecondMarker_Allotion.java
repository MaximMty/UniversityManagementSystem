 ...
 * @author zrche
 */
public class SecondMarker_Allotion extends javax.swing.JFrame {

    private static Submission submission;
    /**
     * Creates new form SecondMarker_Allotion
     */
    public SecondMarker_Allotion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Second Marker by Intake", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Second Marker by Individual", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(ViewIndividualBttn, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
                .addGap(12, 12, 12))
        );
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(491, 491, 491)
                        .addComponent(HomeBttn, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(HomeBttn, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(17, Short.MAX_VALUE))
        );
    ...
    public void addInfoIntoTable(){
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src\\textfile\\Assessment.txt"))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if(!fields[0].equals("NONE(INDIVIDUAL)") && fields[4].equals(ShowUserIdLbl.getText())){
    ...
    private void ViewIntakeBttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewIntakeBttnActionPerformed
        ...
        if (selectedRow != -1) { // -1 indicates no row is selected
            ...
            SecondMarker_Allotion.submission = new Submission(rowData[0].toString(),rowData[1].toString());
            this.dispose();
    ...
    private void ViewIndividualBttnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewIndividualBttnActionPerformed
        ...
        if (selectedRow != -1) { // -1 indicates no row is selected
            ...
            // save the submission details that are chosen from the table
            SecondMarker_Allotion.submission = new Submission("NONE(INDIVIDUAL)",rowData[0].toString(),rowData[1].toString());
            this.dispose();
    ...
    public static Submission getSubmission(){
        return SecondMarker_Allotion.submission;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecondMarker_Allotion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
